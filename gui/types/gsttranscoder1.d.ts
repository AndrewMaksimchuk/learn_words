...
export function transcoder_message_parse_error(msg: Gst.Message): [GLib.Error, Gst.Structure];
...
export function transcoder_message_parse_warning(msg: Gst.Message): [GLib.Error, Gst.Structure];
