...
export class GLTextureBuilder extends GObject.Object {
    ...
    constructor(properties?: Partial<GLTextureBuilder.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<GLTextureBuilder.ConstructorProperties>, ...args: any[]): void;
...
export class DragSurfaceSize {
    ...
    constructor(copy: DragSurfaceSize);
...
export class TextureDownloader {
    ...
    constructor(copy: TextureDownloader);
