...
export function tag_image_data_to_image_sample(image_data: Uint8Array | string, image_type: TagImageType): Gst.Sample;
...
export function tag_list_new_from_id3v1(data: Uint8Array | string): Gst.TagList;
