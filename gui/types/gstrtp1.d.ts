...
export abstract class RTPBaseDepayload extends Gst.Element {
    ...
    connect(
        ...
        callback: (_source: this, ext_id: number, ext_uri: string | null) => RTPHeaderExtension
    ): number;
    connect_after(
        signal: "request-extension",
        callback: (_source: this, ext_id: number, ext_uri: string | null) => RTPHeaderExtension
...
export abstract class RTPBasePayload extends Gst.Element {
    ...
    connect(
        signal: "request-extension",
        callback: (_source: this, ext_id: number, ext_uri: string) => RTPHeaderExtension
    ): number;
    connect_after(
        signal: "request-extension",
        callback: (_source: this, ext_id: number, ext_uri: string) => RTPHeaderExtension
...
export class RTPBuffer {
    ...
    get_extension_data(): [GLib.Bytes, number];
