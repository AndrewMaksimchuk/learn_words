...
export const META_TAG_MEMORY_REFERENCE_STR: string;
...
export function value_set_int64_range_step(value: GObject.Value | any, start: number, end: number, step: number): void;
export function value_set_int_range(value: GObject.Value | any, start: number, end: number): void;
export function value_set_int_range_step(value: GObject.Value | any, start: number, end: number, step: number): void;
