...
export class AlertDialog extends GObject.Object {
    ...
    set cancelButton(val: number);
    get default_button(): number;
    set default_button(val: number);
    get defaultButton(): number;
    set defaultButton(val: number);
    get detail(): string;
...
export class Application extends Gio.Application implements Gio.ActionGroup, Gio.ActionMap {
    ...
    remove_action_entries(entries: Gio.ActionEntry, n_entries: number): void;
...
export class ColorDialog extends GObject.Object {
    ...
    get withAlpha(): boolean;
    set withAlpha(val: boolean);
    ...
    choose_rgba(parent?: Window | null, initial_color?: Gdk.RGBA | null, cancellable?: Gio.Cancellable | null): void;
...
export class ColumnView extends Widget implements Accessible, Buildable, ConstraintTarget, Scrollable {
    ...
    get headerFactory(): ListItemFactory;
    set headerFactory(val: ListItemFactory);
    ...
    get rowFactory(): ListItemFactory;
    set rowFactory(val: ListItemFactory);
    ...
    get tabBehavior(): ListTabBehavior;
    set tabBehavior(val: ListTabBehavior);
...
export module ColumnViewSorter {
    export interface ConstructorProperties extends Sorter.ConstructorProperties {
        ...
        primarySortColumn: ColumnViewColumn;
        primary_sort_order: SortType;
        primarySortOrder: SortType;
    }
}
export class ColumnViewSorter extends Sorter {
    ...
    get primarySortColumn(): ColumnViewColumn;
    get primary_sort_order(): SortType;
    get primarySortOrder(): SortType;
...
export class EventControllerKey extends EventController {
    ...
    connect_after(signal: "modifiers", callback: (_source: this, keyval: Gdk.ModifierType) => boolean): number;
...
export class FontDialog extends GObject.Object {
    ...
    get fontMap(): Pango.FontMap;
    set fontMap(val: Pango.FontMap);
...
export class GestureStylus extends GestureSingle {
    ...
    get stylusOnly(): boolean;
    set stylusOnly(val: boolean);
...
export class Inscription extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    implements Gio.ListModel<A>, SectionModel<A>
{
    ...
    get sectionSorter(): Sorter;
    set sectionSorter(val: Sorter);
    get sorter(): Sorter;
    set sorter(val: Sorter);
