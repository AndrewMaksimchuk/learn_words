...
export function init(argv: string[]): string[];
export function init_check(argv: string[]): [boolean, string[]];
...
export function parse_args(argv: string[]): string[];
...
export function query_visual_types(): VisualType[];
...
export function setting_get(name: string, value: GObject.Value | any): boolean;
...
export type WindowChildFunc = (window: Window) => boolean;
...
export abstract class Window extends GObject.Object {
    ...
    connect(signal: "pick-embedded-child", callback: (_source: this, x: number, y: number) => Window | null): number;
    connect_after(
    ...
    emit(signal: "to-embedder", offscreen_x: number, offscreen_y: number, embedder_x: number, embedder_y: number): void;
...
export class EventConfigure {
    ...
    constructor(copy: EventConfigure);
...
export class EventCrossing {
    ...
    constructor(copy: EventCrossing);
...
export class EventGrabBroken {
    ...
    constructor(copy: EventGrabBroken);
...
export class EventOwnerChange {
    ...
    constructor(copy: EventOwnerChange);
...
export class EventPadButton {
    ...
    constructor(copy: EventPadButton);
...
export class EventPadGroupMode {
    ...
    constructor(copy: EventPadGroupMode);
...
export class EventProperty {
    ...
    constructor(copy: EventProperty);
...
export class EventProximity {
    ...
    constructor(copy: EventProximity);
...
export class EventSelection {
    ...
    constructor(copy: EventSelection);
...
export class EventTouchpadPinch {
    ...
    constructor(copy: EventTouchpadPinch);
...
export class EventTouchpadSwipe {
    ...
    constructor(copy: EventTouchpadSwipe);
...
export class EventVisibility {
    ...
    constructor(copy: EventVisibility);
...
export class EventWindowState {
    ...
    constructor(copy: EventWindowState);
...
export class WindowRedirect {
    ...
    constructor(copy: WindowRedirect);
}
