...
export class GLDisplay extends Gst.Object {
    ...
    connect(signal: "create-context", callback: (_source: this, context: GLContext) => GLContext): number;
    connect_after(signal: "create-context", callback: (_source: this, context: GLContext) => GLContext): number;
    ...
    find_window(data: any | null, compare_func: GLib.CompareFunc): GLWindow;
    get_gl_api(): GLAPI;
    ...
    retrieve_window(data: any | null, compare_func: GLib.CompareFunc): GLWindow;
